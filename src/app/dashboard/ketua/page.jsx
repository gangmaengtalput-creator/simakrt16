...
import PenggalanganDanaView from '../../../components/DashboardKetua/PenggalanganDanaView';
import CustomFieldsView from '../../../components/DashboardKetua/CustomFieldsView';
      ...
      <div className="max-w-7xl mx-auto">
        {activeView === 'menu' && (
          <MainMenu 
            ...
            goToCustomFields={() => setActiveView('custom_fields')}
          />
        )}
        ...
        {/* TAMBAHAN: View Switcher untuk Penggalangan Dana */}
        {activeView === 'penggalangan_dana' && (
          <PenggalanganDanaView
            setActiveView={setActiveView}
            showModal={showModal}
          />
        )}

        {activeView === 'custom_fields' && (
          <CustomFieldsView setActiveView={setActiveView} />
        )}
      </div>
